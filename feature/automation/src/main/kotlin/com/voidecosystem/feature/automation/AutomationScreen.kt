...
/**
 * Route registration for the Automation module — imported by :app's nav graph.
 * Pillar: AI & Automation — AccessibilityService-driven workflow automation
 */
...
@Composable
fun AutomationRoute(onBack: () -> Unit = {}) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Accessibility Automation") },
                navigationIcon = {
