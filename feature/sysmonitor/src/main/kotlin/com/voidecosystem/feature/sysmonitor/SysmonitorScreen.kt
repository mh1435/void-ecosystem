...
/**
 * Route registration for the Sysmonitor module — imported by :app's nav graph.
 * Pillar: System & Developer Tools — RAM/CPU/battery analytics dashboard
 */
...
@Composable
fun SysmonitorRoute(onBack: () -> Unit = {}) {
    Scaffold(
        topBar = {
            TopAppBar(
