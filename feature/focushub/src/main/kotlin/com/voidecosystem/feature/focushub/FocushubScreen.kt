...
/**
 * Route registration for the Focushub module — imported by :app's nav graph.
 * Pillar: Productivity & Life Tracking — gamified focus timer & habits
 */
...
@Composable
fun FocushubRoute(onBack: () -> Unit = {}) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Study & Focus Hub") },
                navigationIcon = {
